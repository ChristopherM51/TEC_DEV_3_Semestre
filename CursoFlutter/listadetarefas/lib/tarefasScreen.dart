...
import 'package:listadetarefas/tarefasController.dart';
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, indice) {
                    return ListTile(
                      ...
                      title: Text(model.tarefas[indice].descricao),
                      // Checkbox para marcar a tarefa como concluída
                      trailing: Checkbox(
                        value: model.tarefas[indice].concluida,
                        onChanged: (value) {
